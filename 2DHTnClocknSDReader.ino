...
//initilize their smog sensor
//const int smogPin = A0;
...
// gathering smog readings from sensor

//smogPPM = analogRead(smogPin);
...
delay(60000); // 60000 mili secs = 1 minute  
}
}
